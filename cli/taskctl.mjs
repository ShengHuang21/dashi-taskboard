  ...
  try {
    ...
    if (parsed.options.help) {
      ...
      if (!help || parsed.operands.length > 0 || Object.keys(parsed.options).length !== 1) {
        throw usageError("Help is available for taskctl, taskctl authority, taskctl coordinator, taskctl issue, taskctl run, taskctl handoff, taskctl clarification, and taskctl comment list");
      }
      stdout.write(`${help}\n`);
      return 0;
    }
